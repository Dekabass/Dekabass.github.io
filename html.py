...
def footer(*children, **tags): return _html_element_from_func(*children, **tags)
def header(*children, **tags): return _html_element_from_func(*children, **tags)
def main(*children, **tags): return _html_element_from_func(*children, **tags)
def section(*children, **tags): return _html_element_from_func(*children, **tags)
def nav(*children, **tags): return _html_element_from_func(*children, **tags)
